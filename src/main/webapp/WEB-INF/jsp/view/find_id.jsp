...
<link rel="stylesheet" type="text/css" href="${root }/css/find_id.css">
<meta charset="UTF-8">
...
<body>
	...
	<div class="find_id_wrap">
		...
		<form class="find_id_form" method="POST" id="find_id_form">
			...
			<div class="email_input" id="email_input">
				<div class="email_input_text">
					<input style="font-size: 12px;" type="text" name="member_email" id="email_id" placeholder="가입한 이메일 주소">@
