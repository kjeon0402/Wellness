...
<body>
	...
	<div class="package_list_wrap">
		...
		<div class="cate_wrap">
			<div class="btn_wrap">
				<div><button onclick="location.href='${root}/package_list_nature'">자연교감형 패키지</button></div>
				<div><button onclick="location.href='${root}/package_list_ocean'">해양체험형 패키지</button></div>
				<div><button style="border: 1px solid #72886C; background-color: #72886C; color: white;" onclick="location.href='${root}/package_list_story'">스토리텔링형 패키지</button></div>
			</div>
		</div>
		<!-- 정렬(최신/인기순) -->
		<div class="sort_wrap">
