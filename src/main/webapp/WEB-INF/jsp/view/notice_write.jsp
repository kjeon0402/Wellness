		...
		<table class="gw_form_table">
			<tbody>
				<tr>
					<td>제목</td>
					<td>
						<div class="sctd_div"><input type="text" name="notice_title" placeholder="제목을 입력해주세요." required></div>
					</td>
				</tr>
				<tr>
					<td>내용</td>
					<td>
						<div class="sctd_div sctd_div2"><textarea name="notice_content" placeholder="내용을 입력해주세요." required></textarea></div>
					</td>
				</tr>
				<tr>
					<td>첨부</td>
