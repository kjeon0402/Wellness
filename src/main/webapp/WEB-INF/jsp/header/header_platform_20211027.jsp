...
.banner {
	width: 100%;
	height: 150px;
	background-image: url("${root}/img/view/header/header_platform.svg");
	background-size: 100%;
}
.banner_menu_bar {
	width: 100%;
...
<div class="header_wrap">
	...
	<div class="banner_menu_bar">
		...
		<div class="bar_inner b">
			<select id="big_category" onchange="showSmall()" disabled>
				<option value="a" selected>부산웰니스관광플랫폼</option>
				<option value="b">부산웰니스관광지</option>
